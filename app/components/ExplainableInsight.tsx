...
export default function ExplainableInsight({ insight }: { insight: ExplainableInsightData }) {
  ...
  return <>
    ...
    {open ? <div aria-labelledby={titleId} aria-modal="true" className="fixed inset-0 z-50" role="dialog">
      ...
      <aside className="absolute inset-y-0 right-0 w-full max-w-xl overflow-y-auto border-l border-neutral-700 bg-neutral-950 p-5 text-neutral-100 shadow-2xl">
        <div className="flex items-start justify-between gap-4">
          ...
          <button className="rounded border border-neutral-600 px-3 py-2 text-sm" onClick={() => setOpen(false)} type="button">Cerrar</button>
        </div>
