...
const systemCategories = [
  ...
  { id: 'income_pension', parentId: 'income', code: 'income_pension', displayName: 'Pension', kind: 'income', isSystem: true, sortOrder: 1107 },
  { id: 'income_severance', parentId: 'income', code: 'income_severance', displayName: 'Severance', kind: 'income', isSystem: true, sortOrder: 1108 },
  { id: 'income_unemployment', parentId: 'income', code: 'income_unemployment', displayName: 'Unemployment', kind: 'income', isSystem: true, sortOrder: 1109 },
